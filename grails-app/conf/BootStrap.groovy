...
class BootStrap {
    ...
    def init = { servletContext ->
        ...
        def managerRole = Role.findOrSaveWhere(authority: Role.MANAGER)
        ...
        def manager = User.findByUsername('manager') ?: new User(username: 'manager', password: 'ManagerKpi123').save()
        ...
        UserRole.findOrSaveWhere(user: manager, role: userRole)
        ...
        UserRole.findOrSaveWhere(user: manager, role: managerRole)
    }
    def destroy = {
    }
}
